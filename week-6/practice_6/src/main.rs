fn main() {
    ...
    let n4 = n1 + &n2 + &n3;
    println!("\n The {} is informed by the aspiration to train the electrical/electronic engineering professionals in the areas of design, building and maintenance of electrical control systems",n4);
